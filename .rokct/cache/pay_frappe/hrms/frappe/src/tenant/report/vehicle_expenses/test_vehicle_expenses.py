...
from {app_name}.hrms.doctype.vehicle_log.test_vehicle_log import get_vehicle, make_vehicle_log
from {app_name}.hrms.doctype.vehicle_log.vehicle_log import make_expense_claim
from {app_name}.hrms.tenant.report.vehicle_expenses.vehicle_expenses import execute
