...
from {app_name}.projects.doctype.timesheet.timesheet import make_sales_invoice
from {app_name}.erp.doctype.employee.test_employee import make_employee

from {app_name}.hrms.tenant.report.project_profitability.project_profitability import execute
from {app_name}.hrms.doctype.salary_slip.salary_slip import make_salary_slip_from_timesheet
from {app_name}.hrms.doctype.salary_slip.test_salary_slip import make_salary_structure_for_timesheet
