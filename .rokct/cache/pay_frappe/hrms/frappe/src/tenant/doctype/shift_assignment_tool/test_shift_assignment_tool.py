...
from {app_name}.hrms.doctype.shift_assignment_tool.shift_assignment_tool import ShiftAssignmentTool
from {app_name}.hrms.doctype.shift_request.test_shift_request import make_shift_request
from {app_name}.hrms.doctype.shift_schedule.shift_schedule import get_or_insert_shift_schedule
