...
from {app_name}.hrms.doctype.payroll_period.payroll_period import get_payroll_period
from {app_name}.hrms.doctype.salary_structure.salary_structure import validate_max_benefit_for_flexible_benefit
...
class SalaryStructureAssignment(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.hrms.doctype.employee_benefit_detail.employee_benefit_detail import EmployeeBenefitDetail
		from {app_name}.hrms.doctype.employee_cost_center.employee_cost_center import EmployeeCostCenter
