...
frappe.ui.form.on("Leave Application", {
	...
	make_dashboard: function (frm) {
		...
		if (frm.doc.employee) {
			frappe.call({
				method: "{app_name}.hrms.doctype.leave_application.leave_application.get_leave_details",
				async: false,
				args: {
					employee: frm.doc.employee,
	...
	get_leave_balance: function (frm) {
		if (
			...
			return frappe.call({
				method: "{app_name}.hrms.doctype.leave_application.leave_application.get_leave_balance_on",
				args: {
					employee: frm.doc.employee,
	...
	calculate_total_days: function (frm) {
		if (frm.doc.from_date && frm.doc.to_date && frm.doc.employee && frm.doc.leave_type) {
			...
			return frappe.call({
				method: "{app_name}.hrms.doctype.leave_application.leave_application.get_number_of_leave_days",
				args: {
					employee: frm.doc.employee,
					leave_type: frm.doc.leave_type,
	...
	set_leave_approver: function (frm) {
		if (frm.doc.employee) {
			return frappe.call({
				method: "{app_name}.hrms.doctype.leave_application.leave_application.get_leave_approver",
				args: {
					employee: frm.doc.employee,
				},
				callback: function (r) {
