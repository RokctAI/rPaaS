...
from {app_name}.hrms.doctype.employee_checkin.employee_checkin import (
...
from {app_name}.hrms.doctype.salary_slip.test_salary_slip import make_holiday_list, make_leave_application
