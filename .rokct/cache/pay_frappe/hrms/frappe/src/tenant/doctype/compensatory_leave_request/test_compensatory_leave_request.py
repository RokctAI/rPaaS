...
from {app_name}.hrms.doctype.attendance_request.test_attendance_request import get_employee
...
from {app_name}.hrms.doctype.leave_application.leave_application import get_leave_balance_on
