...
from {app_name}.erp.doctype.employee.employee import InactiveEmployeeStatusError
from {app_name}.erp.doctype.employee.test_employee import make_employee

from {app_name}.hrms.doctype.leave_allocation.test_leave_allocation import create_leave_allocation
from {app_name}.hrms.doctype.leave_type.test_leave_type import create_leave_type
from {app_name}.hrms.doctype.employee_tax_exemption_declaration.test_employee_tax_exemption_declaration import (
	create_exemption_category,
	create_payroll_period,
)
from {app_name}.hrms.doctype.payroll_entry.payroll_entry import get_month_details
from {app_name}.hrms.doctype.salary_slip.salary_slip import (
...
from {app_name}.hrms.doctype.salary_structure.salary_structure import make_salary_slip
from {app_name}.hrms.tenant.tests.test_utils import get_email_by_subject, get_first_sunday
from {app_name}.hrms.tenant.tests.utils import HRMSTestSuite
...
class TestSalarySlip(HRMSTestSuite):
	...
	def test_leave_details(self):
		from {app_name}.hrms.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_payment_days_for_mid_joinee_including_holidays_and_unmarked_days(self):
		...
		from {app_name}.erp.doctype.holiday_list.holiday_list import is_holiday
	...
	def test_payment_days_calculation_for_lwp_on_month_boundaries(self):
		from {app_name}.hrms.doctype.holiday_list_assignment.test_holiday_list_assignment import (
	...
	def test_payment_days_in_salary_slip_based_on_timesheet(self):
		from {app_name}.projects.doctype.timesheet.test_timesheet import make_timesheet
	...
	def test_component_amount_dependent_on_another_payment_days_based_component(self):
		from {app_name}.hrms.doctype.salary_structure.test_salary_structure import (
	...
	def test_salary_slip_generation_against_opening_entries_in_ssa(self):
		...
		from {app_name}.hrms.doctype.payroll_period.payroll_period import get_period_factor
		from {app_name}.hrms.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_income_tax_unchanged_on_submit_with_exempted_additional_deduction(self):
		from {app_name}.hrms.doctype.payroll_entry.test_payroll_entry import make_payroll_entry
		from {app_name}.hrms.doctype.salary_structure.test_salary_structure import (
			create_salary_structure_assignment,
			make_salary_structure,
		)
		from {app_name}.hrms.tenant.tests.test_utils import create_department
	...
	def test_tax_payable_with_tax_relief_and_marginal_relief_limits(self):
		from {app_name}.hrms.doctype.salary_structure.test_salary_structure import make_salary_structure
		from {app_name}.hrms.tenant.regional.india.setup import setup
