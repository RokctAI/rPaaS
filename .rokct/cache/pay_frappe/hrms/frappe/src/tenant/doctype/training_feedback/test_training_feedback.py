...
from {app_name}.hrms.doctype.training_event.test_training_event import (
	create_training_event,
	create_training_program,
)
from {app_name}.hrms.doctype.salary_structure.test_salary_structure import make_employee
