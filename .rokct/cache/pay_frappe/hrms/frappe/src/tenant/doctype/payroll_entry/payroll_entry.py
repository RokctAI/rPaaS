...
from {app_name}.hrms.doctype.salary_withholding.salary_withholding import link_bank_entry_in_salary_withholdings
...
class PayrollEntry(Document):
	...
	def create_overtime_slips(self) -> None:
		...
		from {app_name}.hrms.doctype.overtime_slip.overtime_slip import (
	...
	def get_overtime_slip_details(self) -> list[bool]:
		from {app_name}.hrms.doctype.overtime_slip.overtime_slip import filter_employees_for_overtime_slip_creation
