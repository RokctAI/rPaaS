...
from {app_name}.erp.doctype.supplier_scorecard.supplier_scorecard import daterange
...
from {app_name}.hrms.tenant.api import get_current_employee_info
from {app_name}.hrms.doctype.leave_block_list.leave_block_list import get_applicable_block_dates
from {app_name}.hrms.doctype.leave_ledger_entry.leave_ledger_entry import create_leave_ledger_entry
from {app_name}.hrms.tenant.hr.utils import (
...
from {app_name}.hrms.tenant.mixins.pwa_notifications import PWANotificationsMixin
from {app_name}.hrms.tenant.utils import get_employee_email
from {app_name}.hrms.tenant.utils.holiday_list import get_holiday_dates_between_range
