...
from {app_name}.hrms.doctype.expense_claim.expense_claim import (
	MismatchError,
	get_advances,
...
class TestExpenseClaim(HRMSTestSuite):
	...
	def test_other_employee_advances_link_with_claim(self):
		from {app_name}.hrms.doctype.employee_advance.test_employee_advance import make_employee_advance
	...
	def test_expense_claim_against_fully_paid_advances(self):
		from {app_name}.hrms.doctype.employee_advance.test_employee_advance import (
	...
	def test_expense_claim_partially_paid_via_advance(self):
		...
		from {app_name}.hrms.doctype.expense_claim.expense_claim import get_expense_claim
	...
	def test_expense_claim_with_deducted_returned_advance(self):
		...
		from {app_name}.hrms.doctype.expense_claim.expense_claim import get_allocation_amount
	...
	def test_expense_claim_against_delivery_trip(self):
		from {app_name}.erp.doctype.delivery_trip.test_delivery_trip import (
			create_address,
	...
	def test_expense_claim_status_as_payment_after_unreconciliation(self):
		from {app_name}.hrms.doctype.employee_advance.test_employee_advance import make_payment_entry
