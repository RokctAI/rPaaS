...
from {app_name}.hrms.doctype.leave_application.test_leave_application import get_first_sunday
from {app_name}.hrms.doctype.shift_type.shift_type import update_last_sync_of_checkin
from {app_name}.hrms.doctype.salary_slip.test_salary_slip import make_holiday_list
from {app_name}.hrms.tenant.tests.test_utils import add_date_to_holiday_list
