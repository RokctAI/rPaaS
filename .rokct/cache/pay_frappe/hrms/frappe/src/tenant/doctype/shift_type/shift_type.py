...
from {app_name}.erp.doctype.holiday_list.holiday_list import is_half_holiday, is_holiday
...
from {app_name}.hrms.doctype.shift_assignment.shift_assignment import get_employee_shift, get_shift_details
