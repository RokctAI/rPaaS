...
from {app_name}.hrms.doctype.job_opening.test_job_opening import get_job_opening
from {app_name}.hrms.doctype.job_requisition.job_requisition import make_job_opening
