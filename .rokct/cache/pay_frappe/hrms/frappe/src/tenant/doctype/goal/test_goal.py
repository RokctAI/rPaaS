...
from {app_name}.hrms.doctype.appraisal_template.test_appraisal_template import create_kras
from {app_name}.hrms.doctype.goal.goal import get_children, update_status
