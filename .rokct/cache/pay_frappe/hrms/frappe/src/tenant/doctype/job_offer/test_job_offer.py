...
from {app_name}.hrms.doctype.job_applicant.job_applicant import get_applicant_to_hire_percentage
from {app_name}.hrms.doctype.job_offer.job_offer import get_offer_acceptance_rate
from {app_name}.hrms.doctype.staffing_plan.test_staffing_plan import make_company
from {app_name}.hrms.tenant.tests.test_utils import create_job_applicant
