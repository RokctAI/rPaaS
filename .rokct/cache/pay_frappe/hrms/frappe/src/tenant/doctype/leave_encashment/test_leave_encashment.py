...
from {app_name}.hrms.doctype.expense_claim.test_expense_claim import get_payable_account
from {app_name}.hrms.doctype.holiday_list_assignment.test_holiday_list_assignment import assign_holiday_list
from {app_name}.hrms.doctype.leave_allocation.leave_allocation import get_unused_leaves
from {app_name}.hrms.doctype.leave_ledger_entry.leave_ledger_entry import process_expired_allocation
from {app_name}.hrms.doctype.leave_period.test_leave_period import create_leave_period
from {app_name}.hrms.doctype.leave_policy.test_leave_policy import create_leave_policy
from {app_name}.hrms.doctype.leave_policy_assignment.leave_policy_assignment import (
	create_assignment_for_multiple_employees,
)
from {app_name}.hrms.doctype.salary_slip.test_salary_slip import (
	make_holiday_list,
	make_leave_application,
)
from {app_name}.hrms.doctype.salary_structure.test_salary_structure import make_salary_structure
from {app_name}.hrms.tenant.tests.test_utils import get_first_sunday
...
class TestLeaveEncashment(HRMSTestSuite):
	...
	def test_status_of_leave_encashment_after_payment_via_salary_slip(self):
		from {app_name}.hrms.doctype.salary_slip.test_salary_slip import make_employee_salary_slip
	...
	def test_status_of_leave_encashment_after_payment_via_payment_entry_and_fnf(self):
		from {app_name}.hrms.doctype.full_and_final_statement.test_full_and_final_statement import (
			create_full_and_final_statement,
		)
		from {app_name}.hrms.tenant.overrides.employee_payment_entry import get_payment_entry_for_employee
