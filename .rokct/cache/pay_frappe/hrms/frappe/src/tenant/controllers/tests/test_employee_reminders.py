...
from {app_name}.hrms.tenant.controllers.employee_reminders import send_holidays_reminder_in_advance
from {app_name}.hrms.doctype.holiday_list_assignment.test_holiday_list_assignment import (
	create_holiday_list_assignment,
)
from {app_name}.hrms.doctype.hr_settings.hr_settings import set_proceed_with_frequency_change
from {app_name}.hrms.tenant.hr.utils import get_holidays_for_employee
from {app_name}.hrms.tenant.tests.utils import HRMSTestSuite


class TestEmployeeReminders(HRMSTestSuite):
	def setUp(self):
		from {app_name}.erp.doctype.holiday_list.test_holiday_list import make_holiday_list
	...
	def test_is_holiday(self):
		from {app_name}.erp.doctype.employee.employee import is_holiday
	...
	def test_birthday_reminders(self):
		...
		from {app_name}.hrms.tenant.controllers.employee_reminders import (
	...
	def test_work_anniversary_reminder_not_sent_for_0_years(self):
		...
		from {app_name}.hrms.tenant.controllers.employee_reminders import get_employees_having_an_event_today
	...
	def test_advance_holiday_reminders_monthly(self):
		from {app_name}.hrms.tenant.controllers.employee_reminders import send_reminders_in_advance_monthly
	...
	def test_advance_holiday_reminders_weekly(self):
		from {app_name}.hrms.tenant.controllers.employee_reminders import send_reminders_in_advance_weekly
