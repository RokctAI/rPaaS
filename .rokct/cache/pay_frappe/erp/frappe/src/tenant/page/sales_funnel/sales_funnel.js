...
erpnext.SalesFunnel = class SalesFunnel {
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "{app_name}.erp.tenant.page.sales_funnel.sales_funnel.get_funnel_data",
			opp_by_utm_source: "{app_name}.erp.tenant.page.sales_funnel.sales_funnel.get_opp_by_utm_source",
			opp_by_utm_campaign: "{app_name}.erp.tenant.page.sales_funnel.sales_funnel.get_opp_by_utm_campaign",
			opp_by_utm_medium: "{app_name}.erp.tenant.page.sales_funnel.sales_funnel.get_opp_by_utm_medium",
			sales_pipeline: "{app_name}.erp.tenant.page.sales_funnel.sales_funnel.get_pipeline_data",
		};
		frappe.call({
