...
from {app_name}.erp.doctype.serial_and_batch_bundle.serial_and_batch_bundle import get_available_serial_nos
...
from {app_name}.erp.tenant.stock.valuation import FIFOValuation, LIFOValuation
...
def get_incoming_rate(args, raise_error_if_no_rate=True, fallbacks: bool = True):
	...
	from {app_name}.erp.tenant.stock.stock_ledger import get_previous_sle, get_valuation_rate
...
def _update_item_info(scan_result: dict[str, str | None], ctx: dict | None = None) -> dict[str, str | None]:
	from {app_name}.erp.tenant.stock.get_item_details import get_item_warehouse_
