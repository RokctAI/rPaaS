...
from {app_name}.erp.tenant.stock.get_item_details import get_item_details
...
class TestGetItemDetail(ERPNextTestSuite):
	...
	def test_apply_price_list_keeps_source_rate_when_maintain_same_rate(self):
		...
		from {app_name}.erp.doctype.purchase_order.test_purchase_order import create_purchase_order
		from {app_name}.erp.tenant.stock.get_item_details import apply_price_list
	...
	def test_rate_lock_source_lookup_checks_permission(self):
		...
		"""
		from {app_name}.erp.doctype.purchase_order.test_purchase_order import create_purchase_order
		from {app_name}.erp.tenant.stock.get_item_details import get_rate_locked_source_row
