...
from {app_name}.erp.doctype.bin.bin import update_qty as update_bin_qty
...
from {app_name}.erp.tenant.stock.valuation import FIFOValuation, LIFOValuation, round_off_if_near_zero
...
def make_sl_entries(sl_entries, allow_negative_stock=False, via_landed_cost_voucher=False):
	...
	args:
	        ...
	        such cases certain validations need to be ignored (like negative
	                        stock)
	"""
	from {app_name}.erp.tenant.controllers.stock_controller import future_sle_exists, invalidate_future_sle_cache
...
class update_entries_after:
	...
	def build(self):
		from {app_name}.erp.tenant.controllers.stock_controller import future_sle_exists
	...
	def update_serial_batch_no_valuation(self, sle, doc, prev_sle=None):
		from {app_name}.erp.tenant.stock.serial_batch_bundle import BatchNoValuation, SerialNoValuation
	...
	def update_batched_values(self, sle):
		from {app_name}.erp.tenant.stock.serial_batch_bundle import BatchNoValuation
