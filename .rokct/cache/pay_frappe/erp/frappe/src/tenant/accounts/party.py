...
from {app_name}.erp.tenant.exceptions import InvalidAccountCurrency, PartyDisabled, PartyFrozen
...
def complete_contact_details(party_details):
	...
	if party_details.party_type == "Employee":
		from {app_name}.erp.doctype.employee.employee import _get_contact_details as get_employee_contact
...
def set_taxes(
	...
	from {app_name}.erp.doctype.tax_rule.tax_rule import get_party_details, get_tax_template
