...
from {app_name}.erp.doctype.budget.budget import validate_expense_against_budget
from {app_name}.erp.tenant.accounts.party import _get_party_details
from {app_name}.erp.tenant.buying.utils import update_last_purchase_rate, validate_for_items
from {app_name}.erp.tenant.controllers.accounts_controller import get_taxes_and_charges
from {app_name}.erp.tenant.controllers.sales_and_purchase_return import get_rate_for_return
...
class BuyingController(SubcontractingController):
	...
	def validate_budget(self):
		if not frappe.get_single_value("Accounts Settings", "use_legacy_budget_controller"):
			from {app_name}.erp.tenant.controllers.budget_controller import BudgetValidation
