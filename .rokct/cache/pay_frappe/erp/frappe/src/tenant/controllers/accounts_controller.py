...
from {app_name}.erp.doctype.accounting_dimension.accounting_dimension import (
...
from {app_name}.erp.tenant.accounts.utils import get_advance_payment_doctypes as _get_advance_payment_doctypes
from {app_name}.erp.tenant.buying.utils import update_last_purchase_rate
from {app_name}.erp.tenant.controllers.print_settings import (
	set_print_templates_for_item_table,
	set_print_templates_for_taxes,
)
from {app_name}.erp.tenant.controllers.sales_and_purchase_return import validate_return
from {app_name}.erp.tenant.exceptions import InvalidCurrency
from {app_name}.erp.tenant.setup.utils import get_exchange_rate
from {app_name}.erp.doctype.item.item import get_uom_conv_factor
...
from {app_name}.erp.tenant.stock.utils import (
	is_group_warehouse,
	validate_disabled_warehouse,
	validate_warehouse_company,
)
from {app_name}.erp.tenant.utilities.regional import temporary_flag
from {app_name}.erp.tenant.utilities.transaction_base import TransactionBase
...
class AccountsController(TransactionBase):
	...
	def on_update(self):
		from {app_name}.erp.tenant.controllers.taxes_and_totals import process_item_wise_tax_details
	...
	def on_trash(self):
		from {app_name}.erp.tenant.accounts.utils import delete_exchange_gain_loss_journal
	...
	def calculate_taxes_and_totals(self):
		from {app_name}.erp.tenant.controllers.taxes_and_totals import calculate_taxes_and_totals
	...
	def validate_due_date(self):
		...
		from {app_name}.erp.tenant.accounts.party import validate_due_date
	...
	def update_against_document_in_jv(self):
		...
		if lst:
			from {app_name}.erp.tenant.accounts.utils import reconcile_against_document
	...
	def on_cancel(self):
		from {app_name}.erp.doctype.bank_transaction.bank_transaction import (
	...
	def validate_multiple_billing(self, ref_dt, item_ref_dn, based_on):
		from {app_name}.erp.tenant.controllers.status_updater import get_allowance_for
	...
	def get_company_default(self, fieldname, ignore_validation=False):
		from {app_name}.erp.tenant.accounts.utils import get_company_default
...
def update_bin_on_delete(row, doctype):
	...
	from {app_name}.erp.tenant.stock.stock_balance import (
		get_indented_qty,
		get_ordered_qty,
		get_reserved_qty,
		update_bin_qty,
...
def update_child_qty_rate(
	...
	from {app_name}.erp.doctype.supplier_quotation.supplier_quotation import get_purchased_items
	from {app_name}.erp.doctype.quotation.quotation import get_ordered_items
	...
	if parent_doctype == "Sales Order" and not parent.is_subcontracted:
		from {app_name}.erp.doctype.stock_reservation_entry.stock_reservation_entry import (
