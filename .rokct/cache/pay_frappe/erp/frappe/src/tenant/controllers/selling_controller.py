...
from {app_name}.erp.tenant.accounts.party import render_address
from {app_name}.erp.tenant.controllers.accounts_controller import get_taxes_and_charges
from {app_name}.erp.tenant.controllers.sales_and_purchase_return import get_rate_for_return, is_batch_expired
from {app_name}.erp.tenant.controllers.stock_controller import StockController
from {app_name}.erp.doctype.item.item import set_item_default
from {app_name}.erp.tenant.stock.get_item_details import get_bin_details, get_conversion_factor
from {app_name}.erp.tenant.stock.utils import get_combine_datetime, get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from {app_name}.erp.tenant.accounts.party import _get_party_details
			...
			from {app_name}.crm.doctype.lead.lead import get_lead_details
	...
	def set_incoming_rate(self):
		...
		from {app_name}.erp.tenant.stock.serial_batch_bundle import get_batch_nos, get_serial_nos
	...
	def validate_items(self):
		...
		from {app_name}.erp.tenant.controllers.buying_controller import validate_item_type
