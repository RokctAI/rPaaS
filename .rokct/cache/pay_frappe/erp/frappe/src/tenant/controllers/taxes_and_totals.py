...
from {app_name}.erp.doctype.journal_entry.journal_entry import get_exchange_rate
from {app_name}.erp.doctype.pricing_rule.utils import get_applied_pricing_rules
...
from {app_name}.erp.tenant.deprecation_dumpster import (
