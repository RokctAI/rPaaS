...
erpnext.utils.set_taxes_from_address = function (
	...
	frappe.call({
		method: "{app_name}.erp.tenant.accounts.party.get_address_tax_category",
		args: {
...
erpnext.utils.set_taxes = function (frm, triggered_from_field) {
	...
	frappe.call({
		method: "{app_name}.erp.tenant.accounts.party.set_taxes",
		args: {
			party: party,
			party_type: party_type,
...
erpnext.utils.get_employee_contact_details = function (frm) {
	...
	frappe.call({
		method: "{app_name}.erp.doctype.employee.employee.get_contact_details",
...
erpnext.utils.get_shipping_address = function (frm, callback) {
	if (frm.doc.company) {
		...
		frappe.call({
			method: "{app_name}.erp.tenant.accounts.custom.address.get_shipping_address",
			args: {
				company: frm.doc.company,
