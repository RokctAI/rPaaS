...
from {app_name}.erp.tenant.report.sales_partner_commission_summary.sales_partner_commission_summary import (
...
class SalesPartnerSummaryReportTestMixin(ERPNextTestSuite):
	...
	def create_transactions(self, doctype):
		from {app_name}.erp.doctype.pos_invoice.test_pos_invoice import (
			POSInvoiceTestMixin,
			create_pos_invoice,
		)
