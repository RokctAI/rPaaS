...
from {app_name}.erp.doctype.sales_invoice.sales_invoice import make_delivery_note, make_sales_return
from {app_name}.erp.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
from {app_name}.erp.tenant.report.gross_profit.gross_profit import GrossProfitGenerator, execute
...
class TestGrossProfit(ERPNextTestSuite):
	...
	def test_drop_ship_return_matches_sales_invoice_item(self):
		...
		from {app_name}.erp.doctype.sales_order.sales_order import make_purchase_order, make_sales_invoice
		from {app_name}.erp.doctype.sales_order.test_sales_order import make_sales_order
	...
	def create_drop_ship_order(self, qty=10, selling_rate=100, buying_rate=80):
		from {app_name}.erp.doctype.purchase_order.purchase_order import make_purchase_invoice
		from {app_name}.erp.doctype.sales_order.sales_order import make_purchase_order
		from {app_name}.erp.doctype.sales_order.test_sales_order import make_sales_order
		from {app_name}.erp.doctype.item.test_item import make_item
