...
from {app_name}.erp.tenant.report.accounts_receivable.accounts_receivable import execute
from {app_name}.erp.tenant.accounts.test.accounts_mixin import AccountsTestMixin
...
class TestAccountsReceivable(ERPNextTestSuite, AccountsTestMixin):
	...
	def test_payment_terms_template_filters(self):
		from {app_name}.erp.tenant.controllers.accounts_controller import get_payment_terms
