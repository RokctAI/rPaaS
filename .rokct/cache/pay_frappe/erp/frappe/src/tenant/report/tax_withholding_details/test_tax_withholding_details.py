...
from {app_name}.erp.doctype.tax_withholding_category.test_tax_withholding_category import (
...
from {app_name}.erp.tenant.report.tax_withholding_details.tax_withholding_details import execute
