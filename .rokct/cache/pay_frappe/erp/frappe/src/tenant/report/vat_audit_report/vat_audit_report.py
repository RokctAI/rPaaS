...
from {app_name}.erp.tenant.erp_init import get_region
from {app_name}.erp.tenant.report.item_wise_sales_register.item_wise_sales_register import get_tax_details_query
