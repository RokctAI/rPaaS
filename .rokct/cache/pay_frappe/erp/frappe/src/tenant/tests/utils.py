...
class BootStrapTestData:
	...
	def make_presets(self):
		...
		from {app_name}.erp.tenant.setup.setup_wizard.operations.install_fixtures import (
			add_uom_data,
			get_preset_records,
			get_sale_stages,
		)
		...
		from {app_name}.erp.tenant.setup.setup_wizard.operations.install_fixtures import read_lines
		...
		from {app_name}.erp.doctype.supplier_scorecard.supplier_scorecard import (
