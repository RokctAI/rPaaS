...
from {app_name}.erp.doctype.work_order.work_order import make_stock_entry as make_stock_entry_from_wo
from {app_name}.erp.doctype.sales_order.sales_order import make_subcontracting_inward_order
...
class IntegrationTestSubcontractingInwardOrder(ERPNextTestSuite):
	...
	def test_subcontracting_delivery(self):
		from {app_name}.erp.tenant.stock.serial_batch_bundle import get_serial_batch_list_from_item
...
def make_service_items():
	from {app_name}.erp.tenant.controllers.tests.test_subcontracting_controller import make_service_item
