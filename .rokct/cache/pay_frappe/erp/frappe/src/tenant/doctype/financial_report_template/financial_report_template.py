...
from {app_name}.erp.doctype.account_category.account_category import import_account_categories
from {app_name}.erp.doctype.financial_report_template.financial_report_validation import TemplateValidator
...
class FinancialReportTemplate(Document):
	...
	def _export_account_categories(self):
		...
		from {app_name}.erp.doctype.financial_report_template.financial_report_engine import (
...
def sync_financial_report_templates(chart_of_accounts=None, existing_company=None):
	from {app_name}.erp.doctype.account.chart_of_accounts.chart_of_accounts import get_chart
