...
from {app_name}.erp.doctype.customer_group.customer_group import get_parent_customer_groups
from {app_name}.erp.doctype.supplier_group.supplier_group import get_parent_supplier_groups
