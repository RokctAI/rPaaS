...
from {app_name}.crm.doctype.lead.lead import get_lead_with_phone_number
from {app_name}.crm.doctype.utils import get_scheduled_employees_for_popup, strip_number
