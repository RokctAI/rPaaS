...
class LandedCostVoucher(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.landed_cost_item.landed_cost_item import LandedCostItem
		from {app_name}.erp.doctype.landed_cost_purchase_receipt.landed_cost_purchase_receipt import (
		...
		from {app_name}.erp.doctype.landed_cost_vendor_invoice.landed_cost_vendor_invoice import (
