...
from {app_name}.erp.tenant.accounts.party import get_party_account, get_party_account_currency
from {app_name}.erp.tenant.buying.utils import validate_for_items
...
from {app_name}.erp.doctype.item.item import get_item_defaults, get_last_purchase_details
from {app_name}.erp.tenant.stock.stock_balance import get_ordered_qty, update_bin_qty
from {app_name}.erp.tenant.stock.utils import get_bin
from {app_name}.erp.doctype.subcontracting_bom.subcontracting_bom import (
...
class PurchaseOrder(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.purchase_order_item.purchase_order_item import PurchaseOrderItem
		from {app_name}.erp.doctype.purchase_order_item_supplied.purchase_order_item_supplied import (
