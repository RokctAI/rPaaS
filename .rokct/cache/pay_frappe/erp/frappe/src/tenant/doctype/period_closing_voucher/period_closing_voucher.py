...
from {app_name}.erp.doctype.account_closing_balance.account_closing_balance import (
	make_closing_entries,
)
from {app_name}.erp.doctype.accounting_dimension.accounting_dimension import (
	get_accounting_dimensions,
)
from {app_name}.erp.tenant.accounts.general_ledger import check_freezing_date, is_immutable_ledger_enabled
from {app_name}.erp.tenant.accounts.utils import get_account_currency, get_fiscal_year
from {app_name}.erp.tenant.controllers.accounts_controller import AccountsController
from {app_name}.erp.doctype.stock_closing_entry.stock_closing_entry import apply_unscoped_filters
from {app_name}.erp.tenant.stock.utils import get_stock_value_on
...
def process_cancellation(voucher_type, voucher_no):
	from {app_name}.erp.tenant.accounts.general_ledger import make_reverse_gl_entries
