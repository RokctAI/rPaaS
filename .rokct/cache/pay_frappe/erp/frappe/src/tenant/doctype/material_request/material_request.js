...
frappe.ui.form.on("Material Request", {
	...
	update_status: function (frm, stop_status) {
		frappe.call({
			method: "{app_name}.erp.doctype.material_request.material_request.update_status",
	...
	make_purchase_order: function (frm) {
		frappe.call({
			method: "{app_name}.erp.doctype.material_request.material_request.get_item_default_suppliers",
			args: {
	...
	select_suppliers_for_items: function (frm, items) {
		...
		const dialog = new frappe.ui.Dialog({
			...
			primary_action: function (values) {
				...
				frappe.call({
					method: "{app_name}.erp.doctype.material_request.material_request.make_purchase_orders_by_supplier",
	...
	make_request_for_quotation: function (frm) {
		frappe.model.open_mapped_doc({
			method: "{app_name}.erp.doctype.material_request.material_request.make_request_for_quotation",
			frm: frm,
			run_link_triggers: true,
		});
	},
	...
	make_supplier_quotation: function (frm) {
		frappe.model.open_mapped_doc({
			method: "{app_name}.erp.doctype.material_request.material_request.make_supplier_quotation",
			frm: frm,
		});
	},
	...
	make_in_transit_stock_entry(frm) {
		frappe.prompt(
			...
			(values) => {
				frappe.call({
					method: "{app_name}.erp.doctype.material_request.material_request.make_in_transit_stock_entry",
					args: {
						source_name: frm.doc.name,
	...
	create_pick_list: (frm) => {
		frappe.model.open_mapped_doc({
			method: "{app_name}.erp.doctype.material_request.material_request.create_pick_list",
			frm: frm,
		});
	},
	...
	raise_work_orders: function (frm) {
		frappe.call({
			method: "{app_name}.erp.doctype.material_request.material_request.raise_work_orders",
			args: {
