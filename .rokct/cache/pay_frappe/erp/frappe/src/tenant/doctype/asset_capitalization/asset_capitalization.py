...
from {app_name}.erp.doctype.asset.asset import get_asset_value_after_depreciation
...
from {app_name}.erp.tenant.stock.utils import get_incoming_rate
...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from {app_name}.erp.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from {app_name}.erp.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (
