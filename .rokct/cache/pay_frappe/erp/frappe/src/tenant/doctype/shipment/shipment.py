...
class Shipment(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.shipment_delivery_note.shipment_delivery_note import ShipmentDeliveryNote
		from {app_name}.erp.doctype.shipment_parcel.shipment_parcel import ShipmentParcel
