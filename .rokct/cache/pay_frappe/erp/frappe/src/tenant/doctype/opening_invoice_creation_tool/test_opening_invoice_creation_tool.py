...
from {app_name}.erp.doctype.opening_invoice_creation_tool.opening_invoice_creation_tool import (
...
class TestOpeningInvoiceCreationTool(ERPNextTestSuite):
	...
	def test_opening_sales_invoice_creation_with_missing_debit_account(self):
		...
		error_log = frappe.db.exists(
			"Error Log",
			{"error": ["like", "%{app_name}.erp.tenant.controllers.accounts_controller.AccountMissingError%"]},
		)
