...
from {app_name}.erp.tenant.stock.serial_batch_bundle import get_serial_nos as get_serial_nos_from_bundle
from {app_name}.erp.tenant.stock.valuation import FIFOValuation
...
class SerialandBatchBundle(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.serial_and_batch_entry.serial_and_batch_entry import SerialandBatchEntry
	...
	def get_valuation_rate_for_return_entry(self, return_against):
		from {app_name}.erp.tenant.controllers.sales_and_purchase_return import get_warehouses_for_return
...
def get_reserved_serial_nos_for_pos(kwargs):
	from {app_name}.erp.tenant.controllers.sales_and_purchase_return import get_returned_serial_nos
