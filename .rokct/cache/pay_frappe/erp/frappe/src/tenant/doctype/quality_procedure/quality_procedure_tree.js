frappe.treeview_settings["Quality Procedure"] = {
	...
	get_tree_nodes: "{app_name}.erp.doctype.quality_procedure.quality_procedure.get_children",
	add_tree_node: "{app_name}.erp.doctype.quality_procedure.quality_procedure.add_node",
	filters: [
		{
