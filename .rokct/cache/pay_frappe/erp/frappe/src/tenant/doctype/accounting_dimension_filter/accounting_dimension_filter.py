...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from {app_name}.erp.doctype.applicable_on_account.applicable_on_account import ApplicableOnAccount
