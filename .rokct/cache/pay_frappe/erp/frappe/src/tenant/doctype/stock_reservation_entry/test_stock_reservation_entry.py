...
from {app_name}.erp.doctype.sales_order.sales_order import create_pick_list, make_delivery_note
...
from {app_name}.erp.doctype.stock_entry.stock_entry import StockEntry
