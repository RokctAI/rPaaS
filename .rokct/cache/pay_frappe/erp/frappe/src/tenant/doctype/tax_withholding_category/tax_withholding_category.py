...
from {app_name}.erp.tenant.erp_init import allow_regional
...
class TaxWithholdingCategory(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.tax_withholding_account.tax_withholding_account import (
			TaxWithholdingAccount,
		)
		from {app_name}.erp.doctype.tax_withholding_rate.tax_withholding_rate import TaxWithholdingRate
