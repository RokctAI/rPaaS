...
from {app_name}.erp.doctype.journal_entry.journal_entry import StockAccountInvalidTransaction
from {app_name}.erp.tenant.exceptions import InvalidAccountCurrency
from {app_name}.erp.doctype.customer.test_customer import make_customer, set_credit_limit
...
class TestJournalEntry(ERPNextTestSuite):
	...
	def test_reverse_journal_entry(self):
		from {app_name}.erp.doctype.journal_entry.journal_entry import make_reverse_journal_entry
