...
class RepostAccountingLedger(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.repost_accounting_ledger_items.repost_accounting_ledger_items import (
...
def _enqueue_repost(repost_doc_name: str) -> None:
	...
	"""
	frappe.enqueue(
		method="{app_name}.erp.doctype.repost_accounting_ledger.repost_accounting_ledger.repost",
...
def repost(repost_doc_name: str, commit: bool = True):
	...
	"""
	from {app_name}.erp.tenant.accounts.utils import _delete_accounting_ledger_entries, _delete_adv_pl_entries
