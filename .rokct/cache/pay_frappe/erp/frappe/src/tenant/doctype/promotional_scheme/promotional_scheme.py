...
class PromotionalScheme(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.campaign_item.campaign_item import CampaignItem
		from {app_name}.erp.doctype.customer_group_item.customer_group_item import CustomerGroupItem
		from {app_name}.erp.doctype.customer_item.customer_item import CustomerItem
		from {app_name}.erp.doctype.pricing_rule_brand.pricing_rule_brand import PricingRuleBrand
		from {app_name}.erp.doctype.pricing_rule_item_code.pricing_rule_item_code import (
			PricingRuleItemCode,
		)
		from {app_name}.erp.doctype.pricing_rule_item_group.pricing_rule_item_group import (
			PricingRuleItemGroup,
		)
		from {app_name}.erp.doctype.promotional_scheme_price_discount.promotional_scheme_price_discount import (
			PromotionalSchemePriceDiscount,
		)
		from {app_name}.erp.doctype.promotional_scheme_product_discount.promotional_scheme_product_discount import (
			PromotionalSchemeProductDiscount,
		)
		from {app_name}.erp.doctype.sales_partner_item.sales_partner_item import SalesPartnerItem
		from {app_name}.erp.doctype.supplier_group_item.supplier_group_item import SupplierGroupItem
		from {app_name}.erp.doctype.supplier_item.supplier_item import SupplierItem
		from {app_name}.erp.doctype.territory_item.territory_item import TerritoryItem
