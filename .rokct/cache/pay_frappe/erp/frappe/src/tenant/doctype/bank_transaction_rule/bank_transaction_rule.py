...
from {app_name}.erp.doctype.bank_transaction.bank_transaction import BankTransaction
...
class BankTransactionRule(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.bank_transaction_rule_accounts.bank_transaction_rule_accounts import (
			BankTransactionRuleAccounts,
		)
		from {app_name}.erp.doctype.bank_transaction_rule_description_conditions.bank_transaction_rule_description_conditions import (
