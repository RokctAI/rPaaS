...
class Supplier(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.customer_number_at_supplier.customer_number_at_supplier import (
	...
	def create_primary_contact(self):
		from {app_name}.erp.doctype.customer.customer import make_contact
	...
	def create_primary_address(self):
		...
		from {app_name}.erp.doctype.customer.customer import make_address
