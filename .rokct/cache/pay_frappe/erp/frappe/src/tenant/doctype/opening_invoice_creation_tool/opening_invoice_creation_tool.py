...
from {app_name}.erp.tenant.stock.utils import get_default_stock_uom
...
class OpeningInvoiceCreationTool(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.opening_invoice_creation_tool_item.opening_invoice_creation_tool_item import (
