...
from {app_name}.erp.tenant.accounts.utils import get_stock_and_account_balance
...
from {app_name}.erp.tenant.stock.stock_ledger import get_previous_sle, update_entries_after
