...
class PackingSlip(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.packing_slip_item.packing_slip_item import PackingSlipItem
...
def item_details(doctype, txt, searchfield, start, page_len, filters):
	from {app_name}.erp.tenant.controllers.queries import get_match_cond
