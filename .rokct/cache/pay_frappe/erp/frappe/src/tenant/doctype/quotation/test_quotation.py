...
from {app_name}.erp.doctype.quotation.quotation import make_sales_order
...
class TestQuotation(ERPNextTestSuite):
	...
	def test_gross_profit(self):
		...
		from {app_name}.erp.tenant.stock.get_item_details import ItemDetailsCtx, insert_item_price
	...
	def test_quotation_expiry(self):
		from {app_name}.erp.doctype.quotation.quotation import set_expired_status
