...
from {app_name}.erp.doctype.financial_report_template.financial_report_template import (
	sync_financial_report_templates,
)
from {app_name}.erp.tenant.setup.setup_wizard.operations.taxes_setup import setup_taxes_and_charges
from {app_name}.erp.tenant.stock.utils import check_pending_reposting
...
class Company(NestedSet):
	...
	def create_default_accounts(self):
		from {app_name}.erp.doctype.account.chart_of_accounts.chart_of_accounts import create_charts
...
def install_country_fixtures(company, country):
	try:
		module_name = f"{app_name}.erp.tenant.regional.{frappe.scrub(country)}.setup.setup"
...
def create_transaction_deletion_request(company):
	...
	from {app_name}.erp.doctype.transaction_deletion_record.transaction_deletion_record import (
