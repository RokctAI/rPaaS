...
from {app_name}.erp.tenant.accounts.party import CROSS_PARTY_FIELD_NO_MAP, get_party_account
from {app_name}.erp.tenant.controllers.selling_controller import SellingController
from {app_name}.erp.doctype.blanket_order.blanket_order import (
...
from {app_name}.erp.tenant.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.sales_order_item.sales_order_item import SalesOrderItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from {app_name}.erp.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from {app_name}.erp.doctype.pricing_rule.utils import update_coupon_code_count
	...
	def update_subcontracting_order_status(self):
		from {app_name}.erp.doctype.subcontracting_inward_order.subcontracting_inward_order import (
...
def create_pick_list(source_name, target_doc=None):
	from {app_name}.erp.doctype.packed_item.packed_item import is_product_bundle
