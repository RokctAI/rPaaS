...
frappe.ui.form.on("Bank Statement Import", {
	...
	show_import_status(frm) {
		...
		frappe.call({
			method: "{app_name}.erp.doctype.bank_statement_import.bank_statement_import.get_import_status",
			args: {
	...
	render_import_log(frm) {
		frappe.call({
			method: "{app_name}.erp.doctype.bank_statement_import.bank_statement_import.get_import_logs",
			args: {
				docname: frm.doc.name,
			},
			callback: function (r) {
