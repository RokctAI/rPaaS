...
from {app_name}.erp.tenant.accounts.deferred_revenue import get_deferred_booking_accounts
...
from {app_name}.erp.doctype.tax_withholding_entry.tax_withholding_entry import JournalTaxWithholding
from {app_name}.erp.tenant.accounts.general_ledger import validate_opening_entry_against_pcv
...
from {app_name}.erp.tenant.setup.utils import get_exchange_rate as _get_exchange_rate
...
class JournalEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.journal_entry_account.journal_entry_account import JournalEntryAccount
	...
	def make_gl_entries(self, cancel=0, adv_adj=0):
		from {app_name}.erp.tenant.accounts.general_ledger import make_gl_entries
