frappe.listview_settings["Sales Order"] = {
	...
	onload: function (listview) {
		var method = "{app_name}.erp.doctype.sales_order.sales_order.close_or_unclose_sales_orders";
		...
		if (frappe.model.can_create("Delivery Note")) {
			listview.page.add_action_item(__("Delivery Note"), () => {
				frappe.call({
					method: "{app_name}.erp.doctype.sales_order.sales_order.is_enable_cutoff_date_on_bulk_delivery_note_creation",
					callback: (r) => {
						if (r.message) {
