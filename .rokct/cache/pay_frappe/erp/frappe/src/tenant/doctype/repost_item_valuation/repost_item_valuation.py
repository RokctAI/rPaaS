...
from {app_name}.erp.tenant.accounts.general_ledger import validate_accounting_period
from {app_name}.erp.tenant.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from {app_name}.erp.tenant.stock.stock_ledger import (
...
def execute_repost_item_valuation():
	...
	method = "{app_name}.erp.doctype.repost_item_valuation.repost_item_valuation.repost_entries"
	if frappe.db.get_single_value("Stock Reposting Settings", "enable_parallel_reposting"):
		method = "{app_name}.erp.doctype.repost_item_valuation.repost_item_valuation.run_parallel_reposting"
