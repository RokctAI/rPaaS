...
from {app_name}.erp.doctype.sales_order.sales_order import create_pick_list
...
from {app_name}.erp.doctype.packed_item.test_packed_item import create_product_bundle
from {app_name}.erp.doctype.pick_list.pick_list import (
	create_delivery,
...
class TestPickList(ERPNextTestSuite):
	...
	def test_pick_list_warehouse_for_work_order(self):
		...
		from {app_name}.erp.doctype.work_order.work_order import create_pick_list, make_work_order
		from {app_name}.erp.doctype.warehouse.test_warehouse import create_warehouse
	...
	def test_multiple_pick_lists_delivery_note(self):
		from {app_name}.erp.doctype.pick_list.pick_list import create_dn_for_pick_lists
	...
	def test_creating_dn_from_so_with_different_addresses(self):
		...
		map_docs(
			"{app_name}.erp.doctype.sales_order.sales_order.create_pick_list",
