...
from {app_name}.erp.doctype.purchase_order.purchase_order import get_mapped_purchase_invoice
from {app_name}.erp.doctype.purchase_order.purchase_order import make_purchase_invoice as make_pi_from_po
...
from {app_name}.erp.tenant.controllers.accounts_controller import InvalidQtyError, get_payment_terms
from {app_name}.erp.tenant.controllers.buying_controller import QtyMismatchError
from {app_name}.erp.tenant.exceptions import InvalidCurrency
...
from {app_name}.erp.doctype.material_request.test_material_request import make_material_request
from {app_name}.erp.doctype.purchase_receipt.purchase_receipt import (
	make_purchase_invoice as create_purchase_invoice_from_receipt,
)
from {app_name}.erp.doctype.purchase_receipt.test_purchase_receipt import (
	get_taxes,
...
from {app_name}.erp.doctype.stock_entry.test_stock_entry import get_qty_after_transaction
from {app_name}.erp.tenant.stock.tests.test_utils import StockTestMixin
...
class TestPurchaseInvoice(ERPNextTestSuite, StockTestMixin):
	...
	def test_update_received_qty_in_material_request(self):
		from {app_name}.erp.doctype.purchase_order.purchase_order import make_purchase_invoice
	...
	def test_hold_methods_are_whitelisted_document_methods(self):
		import {app_name}.erp.doctype.purchase_invoice.purchase_invoice as purchase_invoice_module
	...
	def test_debit_note(self):
		from {app_name}.erp.doctype.payment_entry.test_payment_entry import get_payment_entry
		from {app_name}.erp.doctype.sales_invoice.test_sales_invoice import get_outstanding_amount
	...
	def test_stock_adjustment_account_fallbacks_when_default_expense_account_unset(self):
		from {app_name}.erp.doctype.purchase_invoice.purchase_invoice import PurchaseInvoice
...
def create_tax_witholding_category(category_name, company, account):
	from {app_name}.erp.tenant.accounts.utils import get_fiscal_year
