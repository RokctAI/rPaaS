...
from {app_name}.erp.doctype.pos_profile.pos_profile import (
	get_child_nodes,
)
from {app_name}.erp.tenant.stock.get_item_details import get_pos_profile
...
class TestPOSProfile(ERPNextTestSuite):
	...
	def test_disabled_pos_profile_after_completing_session(self):
		...
		from {app_name}.erp.doctype.pos_closing_entry.test_pos_closing_entry import init_user_and_profile
		from {app_name}.erp.doctype.pos_opening_entry.test_pos_opening_entry import (
