...
from {app_name}.support.doctype.issue.issue import get_holidays
...
class Workstation(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.workstation_cost.workstation_cost import WorkstationCost
		from {app_name}.erp.doctype.workstation_working_hour.workstation_working_hour import (
