...
from {app_name}.erp.tenant.accounts.party import get_due_date
from {app_name}.erp.tenant.exceptions import PartyDisabled, PartyFrozen
from {app_name}.erp.doctype.customer.customer import (
	get_credit_limit,
...
class TestCustomer(ERPNextTestSuite):
	...
	def test_customer_credit_limit_after_submit(self):
		from {app_name}.erp.tenant.controllers.accounts_controller import update_child_qty_rate
		from {app_name}.erp.doctype.sales_order.test_sales_order import make_sales_order
