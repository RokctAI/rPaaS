...
from {app_name}.erp.doctype.purchase_order.purchase_order import get_mapped_subcontracting_order
...
class TestSubcontractingOrder(ERPNextTestSuite):
	...
	def test_stock_reservation_transfer(self):
		...
		from {app_name}.erp.doctype.production_plan.test_production_plan import create_production_plan
		from {app_name}.erp.doctype.stock_reservation_entry.stock_reservation_entry import (
