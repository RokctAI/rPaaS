...
frappe.provide("{app_name}.erp.tenant.buying");
...
frappe.ui.form.on("Purchase Order", {
	setup: function (frm) {
		...
		frm.set_query("expense_account", "items", function () {
			return {
				query: "{app_name}.erp.tenant.controllers.queries.get_expense_account",
	...
	get_materials_from_supplier: function (frm) {
		...
		if (po_details && po_details.length) {
			frm.add_custom_button(
				...
				() => {
					frm.call({
						method: "{app_name}.erp.tenant.controllers.subcontracting_controller.get_materials_from_supplier",
						freeze: true,
...
erpnext.buying.PurchaseOrderController = class PurchaseOrderController extends (
	...
	make_stock_entry() {
		frappe.call({
			method: "{app_name}.erp.tenant.controllers.subcontracting_controller.make_rm_stock_entry",
			args: {
	...
	make_purchase_receipt() {
		frappe.model.open_mapped_doc({
			method: "{app_name}.erp.doctype.purchase_order.purchase_order.make_purchase_receipt",
			frm: this.frm,
	...
	make_purchase_invoice() {
		frappe.model.open_mapped_doc({
			method: "{app_name}.erp.doctype.purchase_order.purchase_order.make_purchase_invoice",
			frm: this.frm,
		});
	}
	...
	make_subcontracting_order() {
		frappe.model.open_mapped_doc({
			method: "{app_name}.erp.doctype.purchase_order.purchase_order.make_subcontracting_order",
			frm: this.frm,
	...
	add_from_mappers() {
		...
		this.frm.add_custom_button(
			...
			function () {
				erpnext.utils.map_current_doc({
					method: "{app_name}.erp.doctype.material_request.material_request.make_purchase_order",
		...
		this.frm.add_custom_button(
			...
			function () {
				erpnext.utils.map_current_doc({
					method: "{app_name}.erp.doctype.supplier_quotation.supplier_quotation.make_purchase_order",
		...
		this.frm.add_custom_button(
			...
			function () {
				...
				frappe.call({
					method: "{app_name}.erp.tenant.buying.utils.get_linked_material_requests",
					args: {
						items: my_items,
					},
					callback: function (r) {
...
cur_frm.cscript.update_status = function (label, status) {
	frappe.call({
		method: "{app_name}.erp.doctype.purchase_order.purchase_order.update_status",
