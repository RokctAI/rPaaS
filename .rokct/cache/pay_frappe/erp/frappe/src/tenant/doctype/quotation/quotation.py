...
class Quotation(SellingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.crm.doctype.competitor_detail.competitor_detail import CompetitorDetail
		from {app_name}.erp.doctype.quotation_item.quotation_item import QuotationItem
		from {app_name}.erp.doctype.quotation_lost_reason_detail.quotation_lost_reason_detail import (
	...
	def carry_forward_communication(self):
		from {app_name}.crm.tenant.utils import copy_comments, link_communications
...
def create_customer_from_lead(lead_name, ignore_permissions=False):
	from {app_name}.crm.doctype.lead.lead import _make_customer
...
def create_customer_from_prospect(prospect_name, ignore_permissions=False):
	from {app_name}.crm.doctype.prospect.prospect import make_customer as make_customer_from_prospect
