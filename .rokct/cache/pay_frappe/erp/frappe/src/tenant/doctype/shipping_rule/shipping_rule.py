...
class ShippingRule(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.shipping_rule_condition.shipping_rule_condition import (
			ShippingRuleCondition,
		)
		from {app_name}.erp.doctype.shipping_rule_country.shipping_rule_country import ShippingRuleCountry
