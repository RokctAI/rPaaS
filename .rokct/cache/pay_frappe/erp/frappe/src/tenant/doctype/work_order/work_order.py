...
from {app_name}.erp.doctype.manufacturing_settings.manufacturing_settings import (
...
from {app_name}.erp.doctype.item.item import get_item_defaults, validate_end_of_life
from {app_name}.erp.doctype.serial_no.serial_no import get_available_serial_nos, get_serial_nos
from {app_name}.erp.doctype.stock_reservation_entry.stock_reservation_entry import StockReservation
from {app_name}.erp.tenant.stock.stock_balance import get_planned_qty, update_bin_qty
from {app_name}.erp.tenant.stock.utils import get_bin, get_latest_stock_qty, validate_warehouse_company
...
class WorkOrder(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.work_order_additional_item.work_order_additional_item import (
			WorkOrderAdditionalItem,
		)
		from {app_name}.erp.doctype.work_order_item.work_order_item import WorkOrderItem
		from {app_name}.erp.doctype.work_order_operation.work_order_operation import WorkOrderOperation
	...
	def update_work_order_qty(self):
		...
		for purpose, fieldname in (
			...
			from {app_name}.erp.doctype.sales_order.sales_order import update_produced_qty_in_so_item
...
def make_work_order(
	...
	from {app_name}.erp.tenant.erp_init import get_default_company
...
def make_stock_return_entry(work_order):
	from {app_name}.erp.doctype.stock_entry.stock_entry import get_available_materials
