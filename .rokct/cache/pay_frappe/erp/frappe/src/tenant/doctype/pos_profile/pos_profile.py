...
class POSProfile(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.pos_customer_group.pos_customer_group import POSCustomerGroup
		from {app_name}.erp.doctype.pos_item_group.pos_item_group import POSItemGroup
		from {app_name}.erp.doctype.pos_payment_method.pos_payment_method import POSPaymentMethod
		from {app_name}.erp.doctype.pos_profile_user.pos_profile_user import POSProfileUser
