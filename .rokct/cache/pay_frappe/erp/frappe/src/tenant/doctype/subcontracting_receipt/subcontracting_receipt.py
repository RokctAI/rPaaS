...
from {app_name}.erp.tenant.controllers.subcontracting_controller import SubcontractingController
...
from {app_name}.erp.tenant.stock.get_item_details import get_default_cost_center, get_default_expense_account
from {app_name}.erp.tenant.stock.stock_ledger import get_valuation_rate
...
class SubcontractingReceipt(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.subcontracting_receipt_item.subcontracting_receipt_item import (
			SubcontractingReceiptItem,
		)
		from {app_name}.erp.doctype.subcontracting_receipt_supplied_item.subcontracting_receipt_supplied_item import (
