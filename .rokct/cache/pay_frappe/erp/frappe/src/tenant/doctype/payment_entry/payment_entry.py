...
from {app_name}.erp.doctype.accounting_dimension.accounting_dimension import get_dimensions
from {app_name}.erp.doctype.bank_account.bank_account import (
	get_bank_account_details,
	get_default_company_bank_account,
	get_party_bank_account,
)
from {app_name}.erp.doctype.invoice_discounting.invoice_discounting import (
	get_party_account_based_on_invoice_discounting,
)
from {app_name}.erp.doctype.journal_entry.journal_entry import get_default_bank_cash_account
from {app_name}.erp.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from {app_name}.erp.doctype.tax_withholding_entry.tax_withholding_entry import PaymentTaxWithholding
...
from {app_name}.erp.tenant.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from {app_name}.erp.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from {app_name}.erp.doctype.payment_entry_reference.payment_entry_reference import (
	...
	def update_payment_requests(self, cancel=False):
		from {app_name}.erp.doctype.payment_request.payment_request import (
