frappe.provide("{app_name}.erp.tenant.edi");
...
erpnext.edi.import_genericode = function (listview_or_form) {
	...
	new frappe.ui.FileUploader({
		method: "{app_name}.erp.doctype.code_list.code_list_import.import_genericode",
		doctype: doctype,
		docname: docname,
...
function show_column_selection_dialog(context) {
	...
	let d = new frappe.ui.Dialog({
		...
		primary_action(values) {
			...
			frappe
				.xcall("{app_name}.erp.doctype.code_list.code_list_import.process_genericode_import", {
