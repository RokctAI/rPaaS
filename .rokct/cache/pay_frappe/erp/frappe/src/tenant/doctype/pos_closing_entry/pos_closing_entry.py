...
from {app_name}.erp.tenant.controllers.status_updater import StatusUpdater
...
class POSClosingEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.pos_closing_entry_detail.pos_closing_entry_detail import (
			POSClosingEntryDetail,
		)
		from {app_name}.erp.doctype.pos_closing_entry_taxes.pos_closing_entry_taxes import (
			POSClosingEntryTaxes,
		)
		from {app_name}.erp.doctype.pos_invoice_reference.pos_invoice_reference import POSInvoiceReference
		from {app_name}.erp.doctype.sales_invoice_reference.sales_invoice_reference import (
