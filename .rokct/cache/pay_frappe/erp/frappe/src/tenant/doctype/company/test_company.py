...
from {app_name}.erp.doctype.company.company import get_default_company_address
...
class TestCompany(ERPNextTestSuite):
	...
	def test_demo_data(self):
		from {app_name}.erp.tenant.setup.demo import clear_demo_data, setup_demo_data
