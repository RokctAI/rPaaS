...
class SubcontractingInwardOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.subcontracting_inward_order_item.subcontracting_inward_order_item import (
			SubcontractingInwardOrderItem,
		)
		from {app_name}.erp.doctype.subcontracting_inward_order_received_item.subcontracting_inward_order_received_item import (
			SubcontractingInwardOrderReceivedItem,
		)
		from {app_name}.erp.doctype.subcontracting_inward_order_secondary_item.subcontracting_inward_order_secondary_item import (
			SubcontractingInwardOrderSecondaryItem,
		)
		from {app_name}.erp.doctype.subcontracting_inward_order_service_item.subcontracting_inward_order_service_item import (
