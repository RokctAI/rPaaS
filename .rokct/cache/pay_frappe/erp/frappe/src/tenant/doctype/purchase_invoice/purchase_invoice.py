...
from {app_name}.erp.doctype.tax_withholding_entry.tax_withholding_entry import PurchaseTaxWithholding
...
from {app_name}.erp.tenant.accounts.party import get_due_date, get_party_account
...
from {app_name}.erp.doctype.asset.asset import is_cwip_accounting_enabled
from {app_name}.erp.doctype.asset_category.asset_category import get_asset_category_account
from {app_name}.erp.tenant.controllers.accounts_controller import merge_taxes, validate_account_head
from {app_name}.erp.tenant.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from {app_name}.erp.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from {app_name}.erp.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from {app_name}.erp.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from {app_name}.erp.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from {app_name}.erp.doctype.purchase_receipt.purchase_receipt import update_billing_percentage
...
def make_purchase_receipt(source_name, target_doc=None, args=None):
	...
	def update_item(obj, target, source_parent):
		from {app_name}.erp.tenant.controllers.sales_and_purchase_return import get_returned_qty_map_for_row
