...
from {app_name}.erp.doctype.tax_rule.tax_rule import ConflictingTaxRule, get_tax_template
from {app_name}.crm.doctype.opportunity.opportunity import make_quotation
