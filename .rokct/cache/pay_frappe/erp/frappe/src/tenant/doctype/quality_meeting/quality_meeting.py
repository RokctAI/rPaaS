...
class QualityMeeting(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.quality_meeting_agenda.quality_meeting_agenda import (
			QualityMeetingAgenda,
		)
		from {app_name}.erp.doctype.quality_meeting_minutes.quality_meeting_minutes import (
