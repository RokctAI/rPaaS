...
from {app_name}.erp.tenant.utilities.transaction_base import TransactionBase, delete_events
...
class MaintenanceSchedule(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.maintenance_schedule_detail.maintenance_schedule_detail import (
			MaintenanceScheduleDetail,
		)
		from {app_name}.erp.doctype.maintenance_schedule_item.maintenance_schedule_item import (
