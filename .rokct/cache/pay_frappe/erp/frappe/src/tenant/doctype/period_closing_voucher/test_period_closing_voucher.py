...
from {app_name}.erp.doctype.finance_book.test_finance_book import create_finance_book
...
class TestPeriodClosingVoucher(ERPNextTestSuite):
	...
	def test_stock_validations_before_period_closing(self):
		...
		with patch("{app_name}.erp.doctype.stock_closing_entry.stock_closing_entry.enqueue"):
			sce.submit()
