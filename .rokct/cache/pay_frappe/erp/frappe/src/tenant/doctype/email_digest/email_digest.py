...
from {app_name}.erp.tenant.accounts.utils import get_balance_on, get_count_on, get_fiscal_year
...
class EmailDigest(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.email_digest_recipient.email_digest_recipient import (
	...
	def get_msg_html(self):
		...
		from {app_name}.erp.doctype.email_digest.quotes import get_random_quote
