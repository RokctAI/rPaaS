...
class SubcontractingOrder(SubcontractingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.subcontracting_order_item.subcontracting_order_item import (
			SubcontractingOrderItem,
		)
		from {app_name}.erp.doctype.subcontracting_order_service_item.subcontracting_order_service_item import (
			SubcontractingOrderServiceItem,
		)
		from {app_name}.erp.doctype.subcontracting_order_supplied_item.subcontracting_order_supplied_item import (
