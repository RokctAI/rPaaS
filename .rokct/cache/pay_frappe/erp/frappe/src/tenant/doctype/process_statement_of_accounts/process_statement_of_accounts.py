...
from {app_name}.erp.tenant.accounts.party import get_party_account_currency
from {app_name}.erp.tenant.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from {app_name}.erp.tenant.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from {app_name}.erp.tenant.report.general_ledger.general_ledger import execute as get_soa
...
class ProcessStatementOfAccounts(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.process_statement_of_accounts_cc.process_statement_of_accounts_cc import (
			ProcessStatementOfAccountsCC,
		)
		from {app_name}.erp.doctype.process_statement_of_accounts_customer.process_statement_of_accounts_customer import (
			ProcessStatementOfAccountsCustomer,
		)
		from {app_name}.erp.doctype.psoa_cost_center.psoa_cost_center import PSOACostCenter
		from {app_name}.erp.doctype.psoa_project.psoa_project import PSOAProject
