...
from {app_name}.erp.tenant.stock.get_item_details import get_company_total_stock, get_conversion_factor
...
class PickList(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.pick_list_item.pick_list_item import PickListItem
