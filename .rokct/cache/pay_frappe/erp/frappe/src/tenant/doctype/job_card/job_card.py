...
from {app_name}.erp.tenant.controllers.stock_controller import (
	QualityInspectionNotSubmittedError,
	QualityInspectionRejectedError,
)
from {app_name}.erp.doctype.bom.bom import add_additional_cost, get_bom_items_as_dict
from {app_name}.erp.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from {app_name}.erp.doctype.workstation_type.workstation_type import get_workstations
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.job_card_item.job_card_item import JobCardItem
		from {app_name}.erp.doctype.job_card_operation.job_card_operation import JobCardOperation
		from {app_name}.erp.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from {app_name}.erp.doctype.job_card_secondary_item.job_card_secondary_item import (
			JobCardSecondaryItem,
		)
		from {app_name}.erp.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog
	...
	def make_stock_entry_for_semi_fg_item(self, auto_submit: bool = False):
		from {app_name}.erp.doctype.stock_entry_type.stock_entry_type import ManufactureEntry
