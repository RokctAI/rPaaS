...
from {app_name}.erp.tenant.controllers.accounts_controller import merge_taxes
from {app_name}.erp.tenant.controllers.buying_controller import BuyingController
from {app_name}.erp.tenant.stock import get_warehouse_account
from {app_name}.erp.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
class PurchaseReceipt(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
...
def make_purchase_invoice(source_name, target_doc=None, args=None):
	...
	from {app_name}.erp.tenant.accounts.party import get_payment_terms_template
