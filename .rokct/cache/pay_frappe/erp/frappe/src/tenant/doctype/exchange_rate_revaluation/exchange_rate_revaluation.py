...
from {app_name}.erp.doctype.journal_entry.journal_entry import get_balance_on
from {app_name}.erp.tenant.accounts.utils import get_currency_precision
...
class ExchangeRateRevaluation(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.exchange_rate_revaluation_account.exchange_rate_revaluation_account import (
