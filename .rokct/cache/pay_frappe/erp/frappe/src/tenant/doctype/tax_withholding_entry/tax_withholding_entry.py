...
from {app_name}.erp.tenant.accounts.utils import get_advance_payment_doctypes
...
from {app_name}.erp.doctype.tax_withholding_category.tax_withholding_category import (
...
class JournalTaxWithholding(TaxWithholdingController):
	...
	def _calculate_net_total(self):
		from {app_name}.erp.tenant.report.general_ledger.general_ledger import get_account_type_map
