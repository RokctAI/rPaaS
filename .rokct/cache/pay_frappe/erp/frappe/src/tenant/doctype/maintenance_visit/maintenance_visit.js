...
frappe.provide("{app_name}.erp.tenant.maintenance");
frappe.ui.form.on("Maintenance Visit", {
	...
	onload: function (frm) {
		...
		if (frm.doc.maintenance_type === "Scheduled") {
			...
			frappe
				.call({
					method: "{app_name}.erp.doctype.maintenance_schedule.maintenance_schedule.get_serial_nos_from_schedule",
					args: {
	...
	refresh() {
		...
		if (this.frm.doc.docstatus === 0) {
			this.frm.add_custom_button(
				...
				function () {
					...
					erpnext.utils.map_current_doc({
						method: "{app_name}.erp.doctype.maintenance_schedule.maintenance_schedule.make_maintenance_visit",
			...
			this.frm.add_custom_button(
				...
				function () {
					erpnext.utils.map_current_doc({
						method: "{app_name}.support.doctype.warranty_claim.warranty_claim.make_maintenance_visit",
