...
from {app_name}.erp.tenant.buying.utils import check_on_hold_or_closed_status, validate_for_items
...
from {app_name}.erp.tenant.stock.get_item_details import get_default_supplier, get_price_list_rate_for
from {app_name}.erp.tenant.stock.stock_balance import get_indented_qty, update_bin_qty
...
class MaterialRequest(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.material_request_item.material_request_item import MaterialRequestItem
