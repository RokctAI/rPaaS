...
from {app_name}.erp.tenant.controllers.queries import item_query as _item_query
from {app_name}.erp.tenant.controllers.sales_and_purchase_return import get_sales_invoice_item_from_consolidated_invoice
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem
...
def create_payments_on_invoice(doc, idx, payment_details):
	from {app_name}.erp.doctype.sales_invoice.sales_invoice import get_bank_cash_account
