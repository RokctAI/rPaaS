...
from {app_name}.erp.tenant.controllers.accounts_controller import InvalidQtyError, get_due_date, update_child_qty_rate
from {app_name}.erp.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from {app_name}.erp.doctype.maintenance_visit.test_maintenance_visit import (
...
from {app_name}.erp.tenant.stock.get_item_details import get_bin_details
...
class TestSalesOrder(ERPNextTestSuite):
	...
	def test_drop_shipping(self):
		from {app_name}.erp.doctype.purchase_order.purchase_order import update_status
		from {app_name}.erp.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_make_work_order(self):
		from {app_name}.erp.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from {app_name}.erp.tenant.controllers.item_variant import create_variant
		from {app_name}.erp.doctype.production_plan.test_production_plan import make_bom
		from {app_name}.erp.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from {app_name}.erp.doctype.material_request.material_request import raise_work_orders
	...
	def test_sales_order_with_shipping_rule_without_cost_center(self):
		from {app_name}.erp.tenant.erp_init import get_default_cost_center
	...
	@patch(
		...
		"{app_name}.erp.doctype.payment_request.payment_request.PaymentRequest.get_payment_url",
		return_value=None,
	)
	...
	def test_pick_list_for_batch(self):
		from {app_name}.erp.doctype.pick_list.pick_list import create_delivery_note
