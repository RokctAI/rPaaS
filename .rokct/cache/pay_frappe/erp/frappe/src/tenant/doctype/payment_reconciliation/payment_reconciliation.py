...
from {app_name}.erp.tenant.controllers.accounts_controller import get_advance_payment_entries_for_regional
...
class PaymentReconciliation(Document):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.payment_reconciliation_allocation.payment_reconciliation_allocation import (
			PaymentReconciliationAllocation,
		)
		from {app_name}.erp.doctype.payment_reconciliation_invoice.payment_reconciliation_invoice import (
			PaymentReconciliationInvoice,
		)
		from {app_name}.erp.doctype.payment_reconciliation_payment.payment_reconciliation_payment import (
