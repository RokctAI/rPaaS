...
from {app_name}.erp.tenant.accounts.deferred_revenue import validate_service_stop_date
from {app_name}.erp.doctype.loyalty_program.loyalty_program import (
	get_loyalty_program_details_with_points,
	validate_loyalty_points,
)
from {app_name}.erp.doctype.pricing_rule.utils import (
	update_coupon_code_count,
	validate_coupon_code,
)
from {app_name}.erp.doctype.repost_accounting_ledger.repost_accounting_ledger import (
	validate_docs_for_deferred_accounting,
	validate_docs_for_voucher_types,
)
from {app_name}.erp.doctype.tax_withholding_entry.tax_withholding_entry import SalesTaxWithholding
from {app_name}.erp.tenant.accounts.general_ledger import get_round_off_account_and_cost_center
from {app_name}.erp.tenant.accounts.party import (
	CROSS_PARTY_FIELD_NO_MAP,
	get_due_date,
	get_party_account,
	get_party_details,
)
from {app_name}.erp.tenant.accounts.utils import (
	get_account_currency,
	refresh_subscription_status,
	update_voucher_outstanding,
)
from {app_name}.erp.doctype.asset.asset import split_asset
from {app_name}.erp.doctype.asset.depreciation import (
	depreciate_asset,
...
from {app_name}.erp.doctype.asset_activity.asset_activity import add_asset_activity
from {app_name}.erp.tenant.controllers.accounts_controller import validate_account_head
from {app_name}.erp.tenant.controllers.selling_controller import SellingController
from {app_name}.projects.doctype.timesheet.timesheet import get_projectwise_timesheet_data
from {app_name}.erp.doctype.company.company import update_company_current_month_sales
from {app_name}.erp.doctype.delivery_note.delivery_note import update_billed_amount_based_on_so
...
class SalesInvoice(SellingController):
	...
	if TYPE_CHECKING:
		...
		from {app_name}.erp.doctype.item_wise_tax_detail.item_wise_tax_detail import ItemWiseTaxDetail
		from {app_name}.erp.doctype.payment_schedule.payment_schedule import PaymentSchedule
		from {app_name}.erp.doctype.pricing_rule_detail.pricing_rule_detail import PricingRuleDetail
		from {app_name}.erp.doctype.sales_invoice_advance.sales_invoice_advance import SalesInvoiceAdvance
		from {app_name}.erp.doctype.sales_invoice_item.sales_invoice_item import SalesInvoiceItem
		from {app_name}.erp.doctype.sales_invoice_payment.sales_invoice_payment import SalesInvoicePayment
		from {app_name}.erp.doctype.sales_invoice_timesheet.sales_invoice_timesheet import (
			SalesInvoiceTimesheet,
		)
		from {app_name}.erp.doctype.sales_taxes_and_charges.sales_taxes_and_charges import (
			SalesTaxesandCharges,
		)
		from {app_name}.erp.doctype.tax_withholding_entry.tax_withholding_entry import TaxWithholdingEntry
		from {app_name}.erp.doctype.sales_team.sales_team import SalesTeam
		from {app_name}.erp.doctype.packed_item.packed_item import PackedItem
	...
	def check_credit_limit(self):
		from {app_name}.erp.doctype.customer.customer import check_credit_limit
	...
	def check_overdue_billing_threshold(self):
		from {app_name}.erp.doctype.customer.customer import check_overdue_billing_threshold
	...
	def set_pos_fields(self, for_validate=False):
		...
		from {app_name}.erp.tenant.stock.get_item_details import (
			ItemDetailsCtx,
			get_pos_profile,
	...
	def update_packing_list(self):
		if cint(self.update_stock) == 1:
			from {app_name}.erp.doctype.packed_item.packed_item import make_packing_list
	...
	def make_gl_entries(self, gl_entries=None, from_repost=False):
		from {app_name}.erp.tenant.accounts.general_ledger import make_gl_entries, make_reverse_gl_entries
	...
	def get_gl_entries(self, inventory_account_map=None):
		from {app_name}.erp.tenant.accounts.general_ledger import merge_similar_entries
	...
	def apply_loyalty_points(self):
		from {app_name}.erp.doctype.loyalty_point_entry.loyalty_point_entry import (
...
def get_list_context(context=None):
	from {app_name}.erp.tenant.controllers.website_list_for_contact import get_list_context
...
def get_loyalty_programs(customer):
	...
	from {app_name}.erp.doctype.customer.customer import get_loyalty_programs
