...
frappe.ui.form.on("Subcontracting Order", {
	...
	update_subcontracting_order_status(frm, status) {
		frappe.call({
			method: "{app_name}.erp.doctype.subcontracting_order.subcontracting_order.update_subcontracting_order_status",
			args: {
				sco: frm.doc.name,
				status: status,
			},
...
erpnext.buying.SubcontractingOrderController = class SubcontractingOrderController {
	...
	make_subcontracting_receipt(items) {
		frappe.model.open_mapped_doc({
			method: "{app_name}.erp.doctype.subcontracting_order.subcontracting_order.make_subcontracting_receipt",
			frm: cur_frm,
			args: { items: items || [] },
			freeze: true,
