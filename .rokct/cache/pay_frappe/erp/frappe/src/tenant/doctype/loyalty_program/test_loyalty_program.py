...
from {app_name}.erp.tenant.accounts.party import get_dashboard_info
...
class TestLoyaltyProgram(ERPNextTestSuite):
	...
	@unittest.mock.patch("{app_name}.erp.doctype.loyalty_program.loyalty_program.get_loyalty_details")
