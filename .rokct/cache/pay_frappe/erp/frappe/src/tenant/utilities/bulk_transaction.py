...
def task(doc_name, from_doctype, to_doctype):
	from {app_name}.erp.doctype.payment_entry import payment_entry
	from {app_name}.erp.doctype.purchase_invoice import purchase_invoice
	from {app_name}.erp.doctype.sales_invoice import sales_invoice
	from {app_name}.erp.doctype.purchase_order import purchase_order
	from {app_name}.erp.doctype.supplier_quotation import supplier_quotation
	from {app_name}.erp.doctype.quotation import quotation
	from {app_name}.erp.doctype.sales_order import sales_order
	from {app_name}.erp.doctype.delivery_note import delivery_note
	from {app_name}.erp.doctype.purchase_receipt import purchase_receipt
