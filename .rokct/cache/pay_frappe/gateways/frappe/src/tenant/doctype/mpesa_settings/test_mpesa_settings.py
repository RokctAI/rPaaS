...
from {app_name}.gateways.doctype.mpesa_settings.mpesa_settings import (
	create_mode_of_payment,
	process_balance_info,
	verify_transaction,
)
from {app_name}.gateways.tenant.tests.utils import PaymentsTestSuite


@patch("{app_name}.gateways.doctype.mpesa_settings.mpesa_settings.get_account_balance")
@patch("{app_name}.gateways.doctype.mpesa_settings.mpesa_settings.generate_stk_push")
