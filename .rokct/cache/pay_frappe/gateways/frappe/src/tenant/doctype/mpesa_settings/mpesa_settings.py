...
from {app_name}.gateways.doctype.mpesa_settings.mpesa_connector import MpesaConnector
from {app_name}.gateways.doctype.mpesa_settings.mpesa_custom_fields import (
	create_custom_pos_fields,
)
from {app_name}.gateways.tenant.utils import erp_module_available, erpnext_app_import_guard
...
def generate_stk_push(**kwargs):
	...
	try:
		callback_url = (
			...
			+ "/api/method/{app_name}.gateways.doctype.mpesa_settings.mpesa_settings.verify_transaction"
		)
...
def get_account_balance(request_payload):
	...
	try:
		...
		callback_url = (
			get_request_site_address(True)
			+ "/api/method/{app_name}.gateways.doctype.mpesa_settings.mpesa_settings.process_balance_info"
		)
