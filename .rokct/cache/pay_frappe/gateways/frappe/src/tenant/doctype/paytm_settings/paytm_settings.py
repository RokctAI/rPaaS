...
# compliance-ignore-file: obs-python-trace (calls the external Paytm PSP API; third-party host does not accept internal trace headers)
import json
...
def get_paytm_params(payment_details, order_id, paytm_config):
	...
	redirect_uri = (
		...
		+ "/api/method/{app_name}.gateways.doctype.paytm_settings.paytm_settings.verify_transaction"
	)
